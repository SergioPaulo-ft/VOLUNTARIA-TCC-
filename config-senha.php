...
// Verificar se o usuário está logado como ONG, se necessário
...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $query = "SELECT senhaOng FROM ongcad WHERE emailOng='$logado'";
    $result = mysqli_query($conexao, $query);
    $user = mysqli_fetch_assoc($result);

    if ($senhaAtual == $user['senhaOng']) {
        if ($novaSenha == $confirmarSenha) {
            $queryUpdate = "UPDATE ongcad SET senhaOng='$novaSenha' WHERE emailOng='$logado'";
    ...
    <div class="container">
        <aside>
            ...
            <div class="sidebar">
                ...
                <a href="config-senha.php" class="active">
        ...
        <main>
            ...
            <div class="recent_order">
                ...
                <form method="POST" action="config-senha.php">
